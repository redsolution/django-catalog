...
class ExtAdminSite(AdminSite):
    ...
    def get_urls(self):
        ...
        urlpatterns = patterns('',
            ...
            # redirects
            url(r'^edit/(\d{1,7})/$',
                wrap(self.editor_redirect, 'catalog.change_treeitem'),
                name='editor_redirect'),
            url(r'^relations/(\d{1,7})/$',
                wrap(self.related_redirect, 'catalog.change_treeitem'),
            ...
            url(r'^json/move/$',
                wrap(self.move_node, 'catalog.change_treeitem'),
            ...
            url(r'^rel/(?P<m2m_name>[\w-]+)/(?P<obj_id>\d+)/$',
                wrap(self.edit_related, 'catalog.change_treeitem'),
            ...
            url(r'^rel/json/(?P<m2m_name>[\w-]+)/(?P<obj_id>\d+)/save/$',
                wrap(self.save_related, 'catalog.change_treeitem'),

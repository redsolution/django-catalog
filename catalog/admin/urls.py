...
urlpatterns = patterns('catalog.admin',
    url(r'^$', login_required(direct_to_template), {'template': 'admin/catalog/main.html'}),
    url(r'^/closepopup$', login_required(direct_to_template), {'template': 'admin/catalog/closepopup.html'}),
